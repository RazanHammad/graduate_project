...
{{ Form::open(['action' => ['webRolesController@update' ,$rules[0]->id], 'method' => 'post','enctype'=>'multipart/form-data']) }}
 ...
 <div class="row">
  <div class="col-lg-4 col-md-12">
     ...
     {{Form::submit('Update',['class'=>'btn btn-primary btn-sm'])}}
      <a class="btn btn-primary btn-sm" href="/webRoles" role="button">Back</a>
      <br>
