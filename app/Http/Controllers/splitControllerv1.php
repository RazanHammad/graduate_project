...
class splitControllerv1 extends Controller
{
    public function split(){
      ...
      dd($row);
     	if(strpos($row, "msg") !== false & strpos($row, "flow") !== false & strpos($row, "content") !== false & strpos($row, "depth") !== false & strpos($row, "reference") !== false & strpos($row, "classtype") !== false & strpos($row, "sid") !== false & strpos($row, "rev") !== false & strpos($row, "metadata") !== false){
