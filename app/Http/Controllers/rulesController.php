...
class rulesController extends Controller
{
    ...
    public function index()
    {
       $sqli_rules= DB::table('sqli_rules')->get();
        ...
        return view('dashboard.pages.sqli_Rules.index', ['sqli_rules' => $sqli_rules]);
    }
    ...
    {
        return view('dashboard.pages.sqli_Rules.create');
    }
...
DB::table('sqli_rules')->insert($data);
    ...
    public function show($id)
    {
       ...
       // dd($rules);
        return view('dashboard.pages.sqli_Rules.show',['rules'=>$rules]);
    }
    ...
    {
        $rules = DB::select('select * from sqli_rules where id = ?',[$id]);
        return view('dashboard.pages.sqli_Rules.edit',['rules'=>$rules]);
    }
